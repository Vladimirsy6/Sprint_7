...
class Order:
    ...
    def __init__(self, color: list = [], first_name: str = "Testname", last_name: str = "Testname", address: str = "smth",
                 ...
                 delivery_date: str = "2025-08-10", comment: str = "test"):
    ...
    def create_order(self):
        payload = {
            ...
            "color": self.color  # должен быть список: [], ['BLACK'], и т.д.
        }

        headers = {'Content-Type': 'application/json'}
        response = requests.post(c.EP_ORDERS, json=payload, headers=headers)
        return response
